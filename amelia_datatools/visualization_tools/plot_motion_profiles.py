...
def plot_hist(base_dir: str, traj_version: str, to_process: bool, input_path: str, motion_profile: str, drop_interp: bool, agent_type: bool, dpi: int, output_dir: str, overlay: bool):
    out_dir = os.path.join(output_dir, utils.get_file_name(__file__))
    os.makedirs(out_dir, exist_ok=True)
    print(f"Created output directory in: {out_dir}")
