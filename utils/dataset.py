...
class BaseDataset(Dataset):
    ...
    def prepare_data(self) -> None:
        ...
        self.blacklist = []
        blacklist_file = os.path.join(self.in_data_dir, f"blacklist.txt")
        if os.path.exists(blacklist_file):
            log.info(f"Loading blacklist; Files in blacklist will be skipped.")
        ...
        for airport in airports:
            ...
            self.limits[airport] = (
                self.ref_data[airport].espg_4326.north, self.ref_data[airport].espg_4326.east, 
                self.ref_data[airport].espg_4326.south, self.ref_data[airport].espg_4326.west)
    ...
    def process_data(self) -> None:
        ...
        # TODO: find cleaner solution to this. Balance the number of scenarios in the multi-airport 
        # setting.
        ...
        with open(f"{self.in_data_dir}/blacklist.txt", 'w') as fp:
            fp.write('\n'.join(self.blacklist))
    ...
    def process_file(self, f: str) -> Tuple[List, List, List, List, List, List]:
        ...
        for i in range(0, num_sequences * self.skip + 1, self.skip):
            ...
            # TODO: Get random agents in scene using as weights safety score
            # scores, scene_score = get_safety_score(
            ...
            # critical_agents_in_scene = sorted_indices
            critical_agents_in_scene = np.asarray(random_agents_in_scene)
            ...
            scenario = {
                ...
                'critical_order': critical_agents_in_scene,
                # 'agent_wise_score': scores,
            ...
            scenario_filepath = os.path.join(data_dir, f"{scenario_id}_{self.split}.pkl")
